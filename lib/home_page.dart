import 'package:courses/details_page.dart';
            ...
            CourseWidget(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          settings: RouteSettings(arguments: courses[0]),
            ...
            CourseWidget(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        settings: RouteSettings(arguments: courses[1]),
                        builder: (context) => const DetailsPage()));
              },
            ),
            CourseWidget(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      settings: RouteSettings(arguments: courses[2]),
                      builder: (context) => const DetailsPage()),
                );
              },
            )
